  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 lg:px-16 flex flex-col items-center text-center">
        ...
        <div className="max-w-2xl mx-auto space-y-6 mb-8 text-light">
          <p
          data-aos="fade-up"
          data-aos-delay="100"
          >
        ...
        <a
          ...
          className="
            ...
            hover:brightness-95 hover:-translate-y-1 hover:shadow-md hover:shadow-white focus:outline-none
            focus:ring-4 focus:ring-border-accent/50
          "
          data-aos="fade-up"
         data-aos-delay="400"
        >
